...
class UpdateTexture:
    ...
    def updateTexture(object):
        ...
        if addon_prefs.smartTexturesMapping:
            ...
            bm.faces[0].loops[1][uv_layer].uv = (scale[1], 0)
            bm.faces[0].loops[2][uv_layer].uv = (scale[1], scale[2])
            bm.faces[0].loops[3][uv_layer].uv = (0, scale[2])
            # right
            bm.faces[1].loops[0][uv_layer].uv = (0, 0)
            bm.faces[1].loops[1][uv_layer].uv = (scale[0], 0)
            bm.faces[1].loops[2][uv_layer].uv = (scale[0], scale[2])
            bm.faces[1].loops[3][uv_layer].uv = (0, scale[2])
            # front
            bm.faces[2].loops[0][uv_layer].uv = (0, 0)
            bm.faces[2].loops[1][uv_layer].uv = (scale[1], 0)
            bm.faces[2].loops[2][uv_layer].uv = (scale[1], scale[2])
            bm.faces[2].loops[3][uv_layer].uv = (0, scale[2])
            # left
            bm.faces[3].loops[0][uv_layer].uv = (0, 0)
            bm.faces[3].loops[1][uv_layer].uv = (scale[0], 0)
            bm.faces[3].loops[2][uv_layer].uv = (scale[0], scale[2])
            bm.faces[3].loops[3][uv_layer].uv = (0, scale[2])
            # bottom
            ...
            bm.faces[5].loops[1][uv_layer].uv = (0, scale[1])
            bm.faces[5].loops[2][uv_layer].uv = (scale[0], scale[1])
            bm.faces[5].loops[3][uv_layer].uv = (scale[0], 0)
